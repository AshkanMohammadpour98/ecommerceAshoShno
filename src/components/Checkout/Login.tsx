// این کامپوننت بخش ورود کاربر را نمایش می‌دهد.
// کاربرانی که قبلاً ثبت نام کرده‌اند می‌توانند با باز کردن این بخش وارد شوند.

import React, { useState } from "react";

const Login = () => {
  const [dropdown, setDropdown] = useState(false); // مدیریت باز و بسته بودن فرم ورود

  return (
    <div className="bg-white shadow-1 rounded-[10px]" dir="rtl">
      {/* تیتر کلی و دکمه باز شدن فرم ورود */}
      <div
      ...
      <div className={`${dropdown ? "block" : "hidden"} pt-7.5 pb-8.5 px-4 sm:px-8.5`}>
        <p className="text-custom-sm mb-6">
          اگر قبلاً وارد نشده‌اید، لطفاً ابتدا وارد شوید.
        </p>
