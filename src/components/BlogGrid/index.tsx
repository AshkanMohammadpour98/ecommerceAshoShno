// 📄 این صفحه لیست مقالات (بلاگ) را به صورت شبکه‌ای همراه با صفحه‌بندی نمایش می‌دهد
...
const BlogGrid = async () => {
  ...
  return (
    <>
      {/* ✅ بخش مسیر ناوبری (Breadcrumb) با عنوان فارسی */}
      <Breadcrumb title={"شبکه مقالات"} pages={["شبکه مقالات"]} />
