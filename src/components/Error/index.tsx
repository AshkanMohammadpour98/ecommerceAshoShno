// این صفحه زمانی نمایش داده می‌شود که کاربر به صفحه‌ای برود که وجود ندارد (404)
// شامل تصویر 404، پیام خطا و دکمه بازگشت به صفحه اصلی است.
...
const Error = () => {
  return (
    <>
      {/* مسیر ناوبری */}
      <Breadcrumb title={"خطا"} pages={["خطا"]} />

      {/* بخش اصلی صفحه */}
      <section className="overflow-hidden py-20 bg-gray-2">
        <div className="max-w-[1170px] w-full mx-auto px-4 sm:px-8 xl:px-0">
          <div className="bg-white rounded-xl shadow-1 px-4 py-10 sm:py-15 lg:py-20 xl:py-25" dir="rtl">
            <div className="text-center">
              ...
              <p className="max-w-[410px] w-full mx-auto mb-7.5">
                به نظر می‌رسد صفحه‌ای که به دنبال آن بودید حذف شده، منتقل شده یا وجود ندارد.
              </p>
