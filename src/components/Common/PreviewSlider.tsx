/**
 * PreviewSliderModal: مودال پیش‌نمایش تصاویر محصول با Swiper و دکمه‌های قبلی/بعدی.
 * کاربرد: نمایش سریع تصویر(های) محصول در یک لایه‌ی تمام‌صفحه با امکان هدایت بین اسلایدها.
 */
