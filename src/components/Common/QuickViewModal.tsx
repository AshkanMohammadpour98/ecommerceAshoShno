"use client";
// QuickViewModal: نمایش سریع جزئیات محصول در یک مودال با قابلیت تغییر تصویر و افزودن به سبد خرید
  ...
  return (
    <div
      className={`${isModalOpen ? "z-99999" : "hidden"
        } fixed top-0 left-0 overflow-y-auto no-scrollbar w-full h-screen sm:py-20 xl:py-10 2xl:py-[100px] bg-dark/70 sm:px-8 px-4 py-5`}
    >
                ...
                <div className="relative z-1 overflow-hidden flex items-center justify-center w-full sm:min-h-[508px] bg-gray-1 rounded-lg border border-gray-3">
                  <div>
                    ...
                    {product?.imgs?.previews?.[activePreview] ? (
                      ...
                      <div className="flex items-center justify-center w-[400px] h-[400px] bg-gray-200 rounded-lg">
                        <span className="text-gray-500 text-xl">تصویر موجود نیست</span>
                        {/* یا می‌تونی یک آیکون SVG هم بذاری */}
                      </div>
                    )}
                  </div>
                </div>
