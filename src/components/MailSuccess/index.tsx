...
const MailSuccess = () => {
  return (
    <>
      <Breadcrumb title={"موفقیت ایمیلی"} pages={["صفحه موفقیت ایمیلی"]} />
          ...
          <div className="bg-white rounded-xl shadow-1 px-4 py-10 sm:py-15 lg:py-20 xl:py-25">
            <div className="text-center">
              ...
              <p className="max-w-[491px] w-full mx-auto mb-7.5">
                از پیام شما بسیار سپاسگزاریم. ما مرتباً ایمیل شما را بررسی می‌کنیم 
                و تمام تلاش خود را برای پاسخ به درخواست شما خواهیم کرد.
              </p>
